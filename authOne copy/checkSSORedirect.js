...
const validReferOrigin = "http://localhost:3000";
const ssoServerJWTURL = "http://localhost:3000/sso/v1/verifytoken";
// const ssoServerJWTURL = "http://localhost:3010/auth/verifytoken";

const ssoRedirect = () => {
  return async function(req, res, next) {
    // check if the req has the queryParameter as ssoToken
    // and who is the referer.
    const { ssoToken, userToken } = req.query;
    if (ssoToken != null) {
